...
public class DatabaseAdapter {
    ...
    private static final String TABLE_MONEY = "money",
        ...
        KEY_MONEY_TYPE_FK = "type",
        KEY_MONEY_DETAILS = "details",
        KEY_MONEY_AMOUNT = "amount",
        KEY_MONEY_DATE = "date",
        KEY_MONEY_CONTACT_FK = "contact",
        KEY_MONEY_REMINDER_FK = "reminder";

    private static final String TABLE_OBJECT = "object",
        KEY_OBJECT_ID = "id",
        KEY_OBJECT_TITLE = "title",
        KEY_OBJECT_TYPE_FK = "type",
        KEY_OBJECT_DETAILS = "details",
        KEY_OBJECT_CATEGORY = "category",
        KEY_OBJECT_DATE = "date",
        KEY_OBJECT_NUMBER = "number",
        KEY_OBJECT_CONTACT_FK = "contact",
        KEY_OBJECT_REMINDER_FK = "reminder";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper
    {
        ...
        public void onCreate(SQLiteDatabase db)
        {
            ...
            db.execSQL("CREATE TABLE " + TABLE_MONEY + "(" + KEY_MONEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + KEY_MONEY_TITLE + " TEXT," +
                    KEY_MONEY_TYPE_FK + " TEXT," + KEY_MONEY_DETAILS + " TEXT," + KEY_MONEY_AMOUNT + " REAL," + KEY_MONEY_DATE + " TEXT " +
                    KEY_MONEY_CONTACT_FK + " INTEGER " + KEY_MONEY_REMINDER_FK + " INTEGER)");

            db.execSQL("CREATE TABLE " + TABLE_OBJECT + "(" + KEY_OBJECT_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + KEY_OBJECT_TITLE + " TEXT," +
                    KEY_OBJECT_TYPE_FK + " TEXT," + KEY_OBJECT_DETAILS + " TEXT," + KEY_OBJECT_CATEGORY + " TEXT," + KEY_OBJECT_DATE + " TEXT" +
                    KEY_OBJECT_NUMBER + " TEXT " + KEY_OBJECT_CONTACT_FK + " INTEGER " + KEY_OBJECT_REMINDER_FK + " INTEGER)");
